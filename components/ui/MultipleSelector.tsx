        ...
        >
          <div className="relative flex flex-wrap gap-1">
            ...
            <CommandPrimitive.Input
              ...
              className={cn(
                "relative flex-1 bg-transparent outline-none placeholder:text-muted-foreground",
                {
          ...
          <div className={cn("w-full", dropdownPositionClass)}>
            <Command>
              <CommandInput
                ...
                onValueChange={(value) => {
                  setInputValue(value);
                  inputProps?.onValueChange?.(inputValue);
                }}
                onBlur={(event) => {
                ...
                className={cn(
                  "relative flex-1 bg-popover text-popover-foreground outline-none placeholder:text-muted-foreground",
                  inputProps?.className
                )}
                visible={withSearch}
              />
