...
export type MissionFormProps = {
  /** Valeurs initiales pour le formulaire (pour l'édition) */
  initialValues?: Partial<CreateMissionFormValues>;
  /** Titre du formulaire */
  title?: ReactNode;
  ...
  /** Si true, n'affichera pas le dialogue de succès */
  disableSuccessDialog?: boolean;
  occupiedJobs?: TeamCount;
