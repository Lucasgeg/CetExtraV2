...
{ "preview": "une description courte de l'article", "seo": ["mot clé 1", "mot clé 2", "mot clé 3", "mot clé 4", "mot clé 5", "mot clé 6", "mot clé 7"], "emailSubject": "titre de l'email", "shortUrl": "nom d'url courte représentative de l'article" }
...
"shortUrl" doit être un nom d'url courte représentative de l'article.
